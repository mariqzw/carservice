                ...
                .authorizeHttpRequests(
                        authorizeHttpRequests ->
                                authorizeHttpRequests.
                                        ...
                                        .permitAll().
                                                requestMatchers("/users/profile", "/offers/add", "/models/add", "/models/all").authenticated().
                                        requestMatchers("/models/list", "/offers/add", "/brands/add", "/users/all", "/brands/list").hasRole("Admin").
